# A股海外产业信号雷达｜2026-09-16 02:11（北京时间）
...
- 触发P1：4条；P2：8条；P3：0条。
- 数据源成功：24条；失败：13条。
- 最强信号：台积电月营收同比（P1）；ICE棉花期货（P1）；布伦特原油现货（P1）；荣昌生物海外临床状态（P1）；CBOT玉米期货（P2）。
...
|P2|CBOT玉米期货|534.75|4.44%|4.65%|上行|Yahoo public chart endpoint|
|P2|ICE原糖期货|18.90|4.07%|4.42%|上行|Yahoo public chart endpoint|
|P2|WTI原油现货|97.26|3.24%|6.32%|上行|FRED|
|P2|CBOT小麦期货|729.25|3.15%|-0.14%|上行|Yahoo public chart endpoint|
|P2|CBOT大豆期货|1,318.00|2.55%|1.19%|上行|Yahoo public chart endpoint|
...
|002311|海大集团|-4.50|0.00|4.50|0.00|CBOT玉米期货(P2/A)；CBOT大豆期货(P2/A)；CBOT小麦期货(P2/A)|否|
|000876|新希望|-3.90|0.00|3.90|0.00|CBOT玉米期货(P2/A)；CBOT大豆期货(P2/A)；CBOT小麦期货(P2/A)|否|
...
|601952|苏垦农发|2.10|2.10|0.00|0.00|CBOT玉米期货(P2/C)；CBOT大豆期货(P2/C)；CBOT小麦期货(P2/C)|否|
