# A股海外产业信号雷达｜2026-09-24 08:47（北京时间）
...
- 触发P1：4条；P2：6条；P3：0条。
- 数据源成功：24条；失败：13条。
- 最强信号：台积电月营收同比（P1）；ICE原糖期货（P1）；布伦特原油现货（P1）；荣昌生物海外临床状态（P1）；ICE棉花期货（P2）。
...
|P1|ICE原糖期货|18.83|7.05%|4.79%|上行|Yahoo public chart endpoint|
|P1|布伦特原油现货|114.89|-1.08%|-12.16%|下行|FRED|
|P1|荣昌生物海外临床状态|1条事件|—|—|下行|A|
|P2|ICE棉花期货|83.02|4.18%|3.21%|上行|Yahoo public chart endpoint|
|P2|费城半导体指数|12,534.27|-1.23%|11.45%|下行|Yahoo public chart endpoint|
|P2|WTI原油现货|96.41|-0.58%|-9.91%|下行|FRED|
|P2|欧元兑人民币|7.63|-0.12%|-0.46%|下行|Yahoo public chart endpoint|
...
|---|---|---:|---:|---:|---:|---|---|
|600938|中国海油|-4.60|0.00|4.60|0.00|布伦特原油现货(P1/A)；WTI原油现货(P2/B)|否|
|000911|广农糖业|3.00|3.00|0.00|0.70|ICE原糖期货(P1/A)；USDA全球农产品供需报告(P2/B)|否|
|601857|中国石油|-3.65|0.00|3.65|0.00|布伦特原油现货(P1/A)；WTI原油现货(P2/B)|否|
...
|300308|中际旭创|1.80|3.00|1.20|0.00|台积电月营收同比(P1/A)；费城半导体指数(P2/C)|否|
|300502|新易盛|1.80|3.00|1.20|0.00|台积电月营收同比(P1/A)；费城半导体指数(P2/C)|否|
...
- **荣昌生物海外临床状态｜2026-09-24｜负向**：NCT05306574状态为TERMINATED：A Study of Telitacicept for the Treatment of Moderately to Severely Active Systemic Lupus Erythematosus (REMESLE-1)  
