# A股海外产业信号雷达｜2026-09-03 14:26（北京时间）
...
- 触发P1：3条；P2：9条；P3：1条。
- 数据源成功：25条；失败：12条。
- 最强信号：布伦特原油现货（P1）；WTI原油现货（P1）；荣昌生物海外临床状态（P1）；台积电月营收同比（P2）；ICE棉花期货（P2）。
...
|P2|CBOT玉米期货|539.50|4.00%|5.73%|上行|Yahoo public chart endpoint|
|P2|COMEX黄金期货|4,474.30|2.47%|-2.94%|上行|Yahoo public chart endpoint|
...
|002311|海大集团|-1.50|0.00|1.50|0.55|CBOT玉米期货(P2/A)；USDA全球农产品供需报告(P3/B)|否|
...
|000876|新希望|-1.30|0.00|1.30|0.50|CBOT玉米期货(P2/A)；USDA全球农产品供需报告(P3/B)|否|
