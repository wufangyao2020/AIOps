# A股海外产业信号雷达｜2026-09-08 02:43（北京时间）
...
- 触发P1：3条；P2：6条；P3：0条。
- 数据源成功：24条；失败：13条。
- 最强信号：布伦特原油现货（P1）；WTI原油现货（P1）；荣昌生物海外临床状态（P1）；台积电月营收同比（P2）；费城半导体指数（P2）。
...
|601339|百隆东方|1.20|1.20|0.00|0.00|ICE棉花期货(P2/B)|否|
|002042|华孚时尚|1.20|1.20|0.00|0.00|ICE棉花期货(P2/B)|否|
...
|000726|鲁泰A|1.00|1.00|0.00|0.00|ICE棉花期货(P2/B)|否|
